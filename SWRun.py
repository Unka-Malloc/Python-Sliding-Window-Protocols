...
def run_sender():
    os.system('python3 Sender2.py 127.0.0.1 55555 sfile.jpg 15')


def run_receiver():
    os.system('python3 Receiver2.py 55555 rfile2.jpg')
...
if __name__ == '__main__':
    ...
    test.start()
    test.join()
    print('Sender/Receiver 2 Stress Testing: Success')
